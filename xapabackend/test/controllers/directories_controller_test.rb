...
class DirectoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post directories_url, params: { directory: { company: @directory.company, founder: @directory.founder, logo: @directory.logo, revenue: @directory.revenue, type: @directory.type } }
    end
  ...
  test "should update directory" do
    patch directory_url(@directory), params: { directory: { company: @directory.company, founder: @directory.founder, logo: @directory.logo, revenue: @directory.revenue, type: @directory.type } }
