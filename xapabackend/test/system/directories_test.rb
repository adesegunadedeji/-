...
class DirectoriesTest < ApplicationSystemTestCase
  ...
  test "creating a Directory" do
    ...
    fill_in "Company", with: @directory.company
    fill_in "Founder", with: @directory.founder
    fill_in "Logo", with: @directory.logo
    fill_in "Revenue", with: @directory.revenue
    fill_in "Type", with: @directory.type
